...
export default function App() {
 ...
 // Add states for sorting criteria and order and search
const [sortCriteria, setSortCriteria] = useState("name");
const [sortOrder, setSortOrder] = useState("asc");
const [searchTerm, setSearchTerm] = useState("");

// Create a function to handle file sorting
const handleFileSorting = () => {
  ...
  // Function to handle searching of files
     ...
     <div style={styles.fileContainer}>
      ...
      <label htmlFor="sortCriteria">Sort by:</label>
        ...
        <input
              ...
              />
              <button style={styles.controlButton} onClick={handleFileSearch}>
                Search
              </button>
  <button
    style={styles.controlButton}
